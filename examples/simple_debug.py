...
# fframe.lag_features(
#     features=[fframe.target], lags=[1, 2, 3, 12]
# )  # lagged features for 1 month ago, 2 months ago ..., 12 months ago
# fframe.calc_statistical_features(
#     features=[fframe.target], windows=[3, 6, 12], aggregations=["mean", "std"]
# )  # 3, 6, and 12 month rolling aggregations for both mean and std
# fframe.calc_ewma(
#     fframe.target, windows=[3, 6, 12]
# )  # 3, 6, 12 month exponential weighted moving averages
